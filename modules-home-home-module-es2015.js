...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 28, vars: 0, consts: [[1, "h-100", "d-flex", "flex-column", "justify-content-center"], [1, "px-4"], [1, "cc-dark", 2, "letter-spacing", "3px", "font-weight", "bold"], [1, "display-4"], [1, "cc-accent", "display-4"], [1, "cc-dark-secondary", 2, "letter-spacing", "1px"], [2, "letter-spacing", "1px"], [1, "cc-dark", "display-4"], [1, "d-flex", "align-items-center"], [1, "w-50", "text-secondary", 2, "height", "0.5px"], [1, "text-muted"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
